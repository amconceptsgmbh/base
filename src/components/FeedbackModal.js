...
function FeedbackModal({
  ...
  const postForm = async () => {
    ...
    try {
      const response = await fetch('https://qby0loym3e.execute-api.eu-central-1.amazonaws.com/prod', {
        method: 'POST',
        headers: {
        ...
        {submitted ? (
          <div>
            <div className="row text-center">
              ...
              <p>Sie können die Sitzung nun beenden.</p>
            </div>
            <div className="row">
          ...
          <div>
            <div className="row">
              <h3 style={{ marginTop: '10px' }}>Ihr Name:</h3>
              ...
              >
                <textarea
                  ...
                  onChange={(e) => {
                    ...
                    if (t.length < 265) setCustomField2(t);
                  }}
                  value={customField2}
                />
              </div>
            ...
            <div className="row">
              <h2 className="text-center">
                Können Sie Ihre Erfahrungen mit Isabel bewerten?
              </h2>
            </div>
            <div className="row">
              <div
            ...
            <div className="row">
              ...
              <div>(Bitte alle zutreffenden auswählen)</div>
              <div className="mt-3">
            ...
            <div className="row">
              <h3 style={{ marginTop: '10px' }}>Möchten Sie uns noch mehr erzählen?</h3>
              {/* field for custom tags, limited to 20 chars */}
              <div
                className="d-flex custom-items"
                style={{ width: '100%', height: '100px', marginTop: '10px' }}
