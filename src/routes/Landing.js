        ...
        <div className="container d-flex">
                  ...
                  <div className="form-check form-switch">
                    ...
                    >
                      ...
                      <div className="d-block ms-2">
                        Bitte aktivieren Sie ihr Mikrofon, damit ich Sie hören kann.
                      </div>
                    </label>
                  </div>
                </div>
                ...
                <div>
                  <div className="form-check form-switch">
                    ...
                    >
                      ...
                      />
                      <div className="d-block ms-2">
                        Bitte aktivieren Sie Ihre Kamera, damit ich Sie sehen kann.
                      </div>
                    </label>
                  </div>
                </div>
              ...
              <div className="row" style={{ marginBottom: '60px' }}>
                <div>
                  <Link
                    ...
                    type="button"
                  >
                    Starten Sie das Interview mit Isabel
                  </Link>
                </div>
              </div>
              <div className="row">
                <div>
                  ...
                  {' '}
                  <a href="https://www.amconcepts.de/impressum-datenschutz">Weiter zu AM Concepts GmbH</a>
                  .
                </div>
              </div>
              <div className="col" />
          ...
          >
            ...
            <div className="text-center fst-italic">
              Aktivieren Sie bitte Ihre Kamera und das Mikrofon, um das Interview erfolgreich durchführen zu können.
            </div>
          </div> */}
        </div>
      </div>
