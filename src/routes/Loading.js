            ...
            requestedMediaPerms.mic === true && requestedMediaPerms.micDenied === false
              ? (
                <div>
                  ...
                  <p>
                    Sprechen Sie klar und deutlich. Die Persona benötigt im laufenden Gespräch aktuell eine gewisse Reaktionszeit (ca. 2-3 Sekunden) für eine Antwort.
                  </p>
                </div>
              )
              : (
          ...
          <div className="col-11 col-md-6 text-center mobile">
            ...
            <div className="row">
              <div>
                ...
                >
                  { connected || page >= pages.length - 1 ? 'Interview starten' : 'Überspringen' }
                  { !connected && skip
                    ? (
