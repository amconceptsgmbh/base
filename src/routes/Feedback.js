...
function Feedback({ className }) {
  ...
  // default tags
  const tagItems = ['Einfach', 'Intuitiv', 'Langsam', 'Hilfreich', 'Persönlich', 'Verzögert'];
      ...
      setAlertModal(
        <div className="alert-modal-card text-center">
          ...
          <p>
            ...
            Oder geben Sie uns Feedback, damit wir unsere neue Plattform verbessern können.
          </p>
          <div className="mt-2">
            <Link className="btn primary-accent me-2" to="/loading">Erneut beginnen</Link>
            <button
          ...
          </div>
          {
            submitted
              ? (
                <div>
                  <div className="row text-center">
                    ...
                    <p>
                      Sie können die Sitzung nun beenden.
                    </p>
                  </div>
                  <div className="row">
                    <div className="d-flex justify-content-center">
                      <Link to="/loading" className="btn btn-dark me-4" type="button">Erneut beginnen</Link>
                      <Link to="/" className="btn btn-outline-dark" type="button">Ich bin fertig</Link>
                    </div>
                  </div>
                </div>
              )
              : (
                <div>
                  <div className="row">
                    <h2 className="text-center">Können Sie Ihr Erlebnis mit Isabel bewerten?</h2>
                  </div>
                  <div className="row">
                    <div
                  ...
                  <hr />
                  <div className="row">
                    <h3>Wie würden Sie Ihr Erlebnis beschreiben?</h3>
                    <div>(Bitte alle zutreffenden auswählen oder eigenes eingeben)</div>
                    <div className="mt-3">
                  ...
                  <div className="row mt-3">
                    <div className="justify-content-end d-flex">
                      <Link to="/" type="button" className="btn btn-outline-dark me-2">Nein Danke</Link>
                      <button
                        type="button"
